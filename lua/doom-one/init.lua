...
doom_one.set_colorscheme = function()
  ...
  set_hl("Conditional", { fg = dark_theme and utils.lighten(palette.purple, 0.15) }) -- or palette.red })
  ...
  set_hl(
    "Identifier",
    { fg = dark_theme and utils.lighten(palette.violet, 0.15) or utils.darken(palette.magenta, 0.25) }
  )
  ...
  if config.plugins.barbar then
    ...
    set_hl("BufferTabpageFill", { fg = palette.base4, bg = dark_theme and palette.base1 or palette.base8, bold = true })
